...
let income = [{
  ...
  src: "Installation fees",
  amt: 45600
}, {
  src: "Reconnection fees",
  amt: 12800
}, {
  src: "Equipment sales",
  amt: 15400
...
function OwnerDashboard({
  ...
  const tiles = [{
    ...
    value: peso(_collToday),
    icon: PiggyBank,
    tone: "good",
    sub: `${_collN} payment${_collN === 1 ? "" : "s"} · tap to view`,
    onClick: () => setShowColl(true)
  }, {
    label: "Income this Month",
    value: pesoK(_incThisM),
    icon: Banknote,
    tone: "good",
    ...
    value: pesoK(_incLastM),
    icon: Banknote,
    tone: "accent",
    sub: "payments, last month"
  }, {
    label: "Expenses Last Month",
    value: pesoK(_expLastM),
    icon: Receipt,
    tone: "warn",
    sub: "last month"
  }, {
    label: "Net Profit Last Month",
    value: pesoK(_netLastM),
    icon: TrendingUp,
    tone: _netLastM >= 0 ? "good" : "bad",
    sub: "income − expenses"
  }, {
    ...
    icon: Banknote,
    tone: "good",
    sub: "payments, trailing 60 days"
  }, {
    label: "Expenses (last 2 mo)",
    value: pesoK(_exp2),
    icon: Receipt,
    tone: "warn",
    sub: "trailing 60 days"
  }, {
    label: "Net Profit (last 2 mo)",
    value: pesoK(_net2),
    icon: TrendingUp,
    tone: _net2 >= 0 ? "good" : "bad",
    sub: "income − expenses"
  }, {
  ...
  }, "\xB7 ", peso(_collToday), " from ", _collList.length, " payment", _collList.length === 1 ? "" : "s")), /*#__PURE__*/React.createElement("button", {
    onClick: () => setShowColl(false),
    className: "grid place-items-center rounded-lg",
    style: {
      width: 30,
...
function Financials({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Monthly cash flow"), /*#__PURE__*/React.createElement("div", {
    style: {
      height: 250
    }
  }, /*#__PURE__*/React.createElement(ResponsiveContainer, null, /*#__PURE__*/React.createElement(BarChart, {
    ...
    t: t
  }, "Expense breakdown"), /*#__PURE__*/React.createElement("div", {
    style: {
      height: 250
    }
...
function ExpensesPage({
  ...
  const deleteAll = async () => {
    ...
    try {
      const res = await API("delete_all_expenses", {
        confirm: "DELETE ALL"
      });
      if (res && res.ok) {
        setFlash(`Deleted ${res.deleted} expense${res.deleted === 1 ? "" : "s"}`);
        setTimeout(() => setFlash(""), 4000);
        onSaved();
      } else {
        setFlash("Delete failed" + (res && res.error ? ": " + res.error : ""));
        setTimeout(() => setFlash(""), 4000);
      }
    } catch (e) {
      setFlash("Delete failed: " + (e.message || ""));
      setTimeout(() => setFlash(""), 4000);
    }
  };
...
function PlansModal({
  ...
  useEffect(() => {
    setRows(cur => {
      ...
      return [...plans, ...cur.filter(r => r._new || !ids[r.id])];
    });
  }, [plans]);
  const inp = {
    width: "100%",
  ...
  const startEdit = row => {
    if (!window.confirm(`Edit this ${row.label} plan for ${empName(row.employee_id)}?`)) return;
    setMsg(null);
    setEditing(e => ({
      ...e,
      [row.id]: true
  ...
  const saveRow = async row => {
    if (!row.employee_id) {
      flash(false, "Pick an employee.");
      return;
    }
    if (!(Number(row.total_amount) > 0) || !(Number(row.terms_total) > 0)) {
      flash(false, "Enter a total amount and number of weeks.");
      return;
    }
    if (!window.confirm(row._new ? `Add this ${row.label} plan for ${empName(row.employee_id)}?` : `Save changes to this plan?`)) return;
    setBusy(true);
    try {
      const r = await prWrite("pr_save_plan", {
        id: row._new ? null : row.id,
        employee_id: row.employee_id,
        kind: row.kind,
        category: row.category || PR_KIND_CAT[row.kind] || "loan",
  ...
  const inner = /*#__PURE__*/React.createElement("div", {
  ...
  }, [["Employee"], ["Type"], ["Category"], ["Total ₱"], ["Weeks", "Payment terms"], ["Interest", "% per week"], ["Weekly pay", "Deducted / week"], ["Payment start", "First deduction"], ["Progress", "Times paid"], ["Remaining", "Balance left"], ["Active"], [""]].map(([h, sub], i) => /*#__PURE__*/React.createElement("th", {
    key: i,
    style: {
      textAlign: "left",
      padding: "6px 8px",
  ...
  }, sub) : null)))), /*#__PURE__*/React.createElement("tbody", null, rows.length === 0 && /*#__PURE__*/React.createElement("tr", null, /*#__PURE__*/React.createElement("td", {
    colSpan: 12,
    style: {
      padding: "14px 8px",
      textAlign: "center",
  ...
  }, "No plans yet \u2014 add one below.")), rows.map(row => /*#__PURE__*/React.createElement("tr", {
    key: row.id,
    style: {
      borderBottom: `1px solid ${t.borderSoft}`
    }
    ...
    onChange: e => set(row.id, "employee_id", e.target.value),
    style: {
      ...inp,
      minWidth: 150
    }
    ...
    onChange: e => {
      ...
      set(row.id, "kind", k);
      set(row.id, "label", kindLabel(k));
      set(row.id, "category", PR_KIND_CAT[k] || "loan");
    },
    style: {
      ...inp,
      minWidth: 110
    ...
    onChange: e => set(row.id, "total_amount", e.target.value),
    style: {
      ...inp,
      width: 80
    }
    ...
    onChange: e => set(row.id, "terms_total", e.target.value),
    style: {
      ...inp,
      width: 60
    }
    ...
    onChange: e => set(row.id, "interest_rate", e.target.value),
    placeholder: "0",
    style: {
      ...inp,
      width: 58
    ...
    onChange: e => set(row.id, "interest_only", e.target.checked ? 1 : 0)
  }), "interest only (extend)")), /*#__PURE__*/React.createElement("td", {
    style: {
      padding: "5px 8px",
      color: t.text,
      fontSize: 12.5,
  ...
  }, peso(perWeek(row)), " + ", peso(wkInterest(row)), " int") : null), /*#__PURE__*/React.createElement("td", {
    style: {
      padding: "5px 8px"
    }
  }, /*#__PURE__*/React.createElement("input", {
    ...
    onChange: e => set(row.id, "start_date", e.target.value),
    style: {
      ...inp,
      width: 138
    }
  ...
  }, row._new ? "—" : (row.terms_done || 0) + " / " + row.terms_total), /*#__PURE__*/React.createElement("td", {
    style: {
      padding: "5px 8px",
      color: t.textFaint,
      fontSize: 12
  ...
  }, empName(row.employee_id)), /*#__PURE__*/React.createElement("td", {
    style: {
      padding: "7px 8px",
      ...cellTxt
    }
  }, kindLabel(row.kind)), /*#__PURE__*/React.createElement("td", {
    style: {
      padding: "7px 8px"
    }
  }, /*#__PURE__*/React.createElement("span", {
  ...
  }, (PR_CATS.find(c => c[0] === (row.category || "loan")) || [null, "Loan"])[1])), /*#__PURE__*/React.createElement("td", {
    style: {
      padding: "7px 8px",
      ...cellTxt
    }
  }, peso(row.total_amount)), /*#__PURE__*/React.createElement("td", {
    style: {
      padding: "7px 8px",
      ...cellTxt
    }
  }, row.terms_total), /*#__PURE__*/React.createElement("td", {
    style: {
      padding: "7px 8px",
      whiteSpace: "nowrap"
    }
  }, Number(row.interest_rate) > 0 ? /*#__PURE__*/React.createElement("span", {
    style: {
      color: t.text,
      fontSize: 12.5,
      fontWeight: 600
    }
  }, row.interest_rate, "% ", /*#__PURE__*/React.createElement("span", {
    style: {
      color: t.textFaint,
      fontWeight: 400
    }
  }, "(", peso(row.weekly_interest != null ? row.weekly_interest : wkInterest(row)), ")")) : /*#__PURE__*/React.createElement("span", {
    style: {
      color: t.textFaint,
      fontSize: 12
    }
  }, "\u2014"), can("payroll") && !done(row) ? /*#__PURE__*/React.createElement("button", {
    onClick: () => toggleIntOnly(row),
    disabled: busy,
    title: "Toggle interest-only (extend / waive the principal for now)",
    style: {
      display: "block",
      marginTop: 3,
      background: row.interest_only ? t.warnSoft : "transparent",
      color: row.interest_only ? t.warn : t.textFaint,
      border: `1px solid ${row.interest_only ? t.warn : t.border}`,
      borderRadius: 6,
      fontSize: 9.5,
      fontWeight: 700,
      padding: "1px 6px",
  ...
  }, row.interest_only ? "● interest only — resume" : "○ set interest only") : row.interest_only ? /*#__PURE__*/React.createElement("div", {
    style: {
      color: t.warn,
      fontSize: 9.5,
      fontWeight: 700
  ...
  }, peso(row.weekly_payment != null ? row.weekly_payment : wkPayment(row))), /*#__PURE__*/React.createElement("td", {
    style: {
      padding: "7px 8px",
      ...cellTxt,
      whiteSpace: "nowrap"
    }
  }, row.start_date || /*#__PURE__*/React.createElement("span", {
    style: {
      color: t.textFaint
    }
    ...
    style: {
      padding: "7px 8px",
      color: done(row) ? t.good : t.textMuted,
      fontSize: 12.5,
      fontWeight: done(row) ? 700 : 400,
      whiteSpace: "nowrap"
    }
  }, (row.terms_done || 0) + " / " + row.terms_total, done(row) ? " ✓" : ""), /*#__PURE__*/React.createElement("td", {
    style: {
      padding: "7px 8px",
      whiteSpace: "nowrap"
    }
  ...
  }, row.remaining_balance != null ? peso(row.remaining_balance) : "—"), row.remaining_weeks > 0 && row.next_deduction_date ? /*#__PURE__*/React.createElement("div", {
    style: {
      color: t.textFaint,
      fontSize: 10
    }
  }, "next ", row.next_deduction_date) : null, row.remaining_weeks > 0 && row.completion_date ? /*#__PURE__*/React.createElement("div", {
    style: {
      color: t.textFaint,
      fontSize: 10
    }
  }, "ends ", row.completion_date) : null), /*#__PURE__*/React.createElement("td", {
    style: {
      padding: "7px 8px",
      textAlign: "center"
    }
  ...
  }, "Loans & installment deductions"), /*#__PURE__*/React.createElement("button", {
    onClick: onClose,
    className: "grid place-items-center rounded-lg",
    style: {
      width: 30,
...
function LoanManagement({
  ...
  }, "\u2014"), can("payroll") && !done(p) ? /*#__PURE__*/React.createElement("button", {
  ...
  }, can("payroll") && /*#__PURE__*/React.createElement("button", {
    onClick: () => startEdit(p),
    style: btn(t.violet + "22", t.violet)
  }, "Edit"), canDel("payroll") && /*#__PURE__*/React.createElement("button", {
    onClick: () => delRow(p),
    style: btn(t.badSoft || "#3a1620", t.bad)
  }, "Delete"))))), newRows.map(row => /*#__PURE__*/React.createElement("tr", {
    key: row._tmp,
    style: {
      borderBottom: `1px solid ${t.borderSoft}`,
      background: (t.accentSoft || "") + "20"
    }
  }, editForm(row, (k, v) => setNew(row._tmp, k, v), () => saveNew(row), () => cancelNew(row._tmp), true)))))), canAdd("payroll") && /*#__PURE__*/React.createElement("button", {
    onClick: addRow,
    className: "inline-flex items-center gap-1.5 rounded-xl mt-3",
    style: {
      background: t.accentSoft,
...
function PayrollPage({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    size: 15
  }), "Rates & schedules"), canAdd("payroll") && /*#__PURE__*/React.createElement("button", {
    onClick: () => setModal({
      type: "period",
      period: null
    }),
    ...
    size: 14
  }), "Edit week"), period && /*#__PURE__*/React.createElement("button", {
    onClick: delPeriod,
    title: "Delete week",
    style: {
      background: "transparent",
    ...
    className: "flex-1"
  }), period && period.status === "draft" && /*#__PURE__*/React.createElement("button", {
    onClick: publish,
    className: "inline-flex items-center gap-1.5 rounded-xl",
    style: {
      background: t.good,
